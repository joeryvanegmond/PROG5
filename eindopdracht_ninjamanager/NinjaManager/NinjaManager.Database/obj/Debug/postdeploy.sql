...
Insert into Category([Category]) values ('Head');
Insert into Category([Category]) values ('Shoulders');
Insert into Category([Category]) values ('Chest');
Insert into Category([Category]) values ('Belt');
Insert into Category([Category]) values ('Legs');
Insert into Category([Category]) values ('Shoes');

insert into Equipment([Name], [Category], [Gold],[Strength],[Agility],[Intelligence]) values ('Hoedje', 'Head', '20', '2', '4', '5');
...
insert into Equipment([Name], [Category], [Gold], [Agility], [Intelligence], [Strength]) values ('Skinny jeans', 'Legs', '30', '-6', '2', '5');
insert into Equipment([Name], [Category], [Gold], [Agility], [Intelligence], [Strength]) values ('Scheenbeschermers', 'Legs', '45', '18', '2', '50');
insert into Equipment([Name], [Category], [Gold], [Agility], [Intelligence], [Strength]) values ('Drollenvanger', 'Legs', '20', '20', '24', '17');

insert into Equipment([Name], [Category], [Gold], [Agility], [Intelligence], [Strength]) values ('Uggs', 'Shoes', '100', '80', '22', '6');
insert into Equipment([Name], [Category], [Gold], [Agility], [Intelligence], [Strength]) values ('Gympies', 'Shoes', '60', '69', '7', '20');
insert into Equipment([Name], [Category], [Gold], [Agility], [Intelligence], [Strength]) values ('Sandalen met sokken', 'Shoes', '69', '420', '420', '420');
GO
